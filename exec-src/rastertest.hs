...
badFilling :: IO ()
badFilling = produceImageAtSize 300 400  "bad_raster.png" $ do
  let path  =
        [ Line (V2 233.9148 322.0685) (V2 220.18799 322.04633)
        , Line (V2 220.18799 322.04633) (V2 213.71329 321.91302)
        , Line (V2 213.71329 321.91302) (V2 211.63109 322.02963)
        , Line (V2 211.63109 322.02963) (V2 183.87248 322.23865)
        , Line (V2 183.87248 322.23865) (V2 180.07088 322.34796)
        , Line (V2 180.07088 322.34796) (V2 164.35748 322.31995)
        , Line (V2 164.35748 322.31995) (V2 160.19788 322.33426)
        , Line (V2 160.19788 322.33426) (V2 160.02777 322.34256)
        , Line (V2 160.02777 322.34256) (V2 144.60327 322.40146)
        , Line (V2 144.60327 322.40146) (V2 144.49257 322.40665)
        , Line (V2 144.49257 322.40665) (V2 131.14056 322.37354)
        , Line (V2 131.14056 322.37354) (V2 128.44107 322.43814)
        , Line (V2 128.44107 322.43814) (V2 128.34447 322.43573)
        , Line (V2 128.34447 322.43573) (V2 127.70177 322.38434)
        , Line (V2 127.70177 322.38434) (V2 114.914665 322.46365)
        , Line (V2 114.914665 322.46365) (V2 114.46266 322.52484)
        , Line (V2 114.46266 322.52484) (V2 102.00936 322.64954)
        , Line (V2 102.00936 322.64954) (V2 100.58116 322.57605)
        , Line (V2 100.58116 322.57605) (V2 86.69896 322.70285)
        , Line (V2 86.69896 322.70285) (V2 72.816956 322.72516)
        , Line (V2 72.816956 322.72516) (V2 68.474655 322.54745)
        , Line (V2 68.474655 322.54745) (V2 49.017456 322.54736)
        , Line (V2 49.017456 322.54736) (V2 45.052757 322.49185)
        , Line (V2 45.052757 322.49185) (V2 12.181557 322.36835)
        , Line (V2 12.181557 322.36835) (V2 12.200657 294.18796)
        , Line (V2 12.200657 294.18796) (V2 12.195257 282.08585)
        , Line (V2 12.195257 282.08585) (V2 12.232557 280.19363)
        , Line (V2 12.232557 280.19363) (V2 12.285357 259.33344)
        , Line (V2 12.285357 259.33344) (V2 12.185457 210.91484)
        , Line (V2 12.185457 210.91484) (V2 12.138857 195.26414)
        , Line (V2 12.138857 195.26414) (V2 12.139057 194.54515)
        , Line (V2 12.139057 194.54515) (V2 12.144457 190.80255)
        , Line (V2 12.144457 190.80255) (V2 12.140157 189.45876)
        , Line (V2 12.140157 189.45876) (V2 12.142756 179.90666)
        , Line (V2 12.142756 179.90666) (V2 12.142056 172.28476)
        , Line (V2 12.142056 172.28476) (V2 12.173057 155.01315)
        , Line (V2 12.173057 155.01315) (V2 12.260157 146.37575)
        , Line (V2 12.260157 146.37575) (V2 12.532557 130.83936)
        , Line (V2 12.532557 130.83936) (V2 12.469156 113.926056)
        , Line (V2 12.469156 113.926056) (V2 12.488656 103.983955)
        , Line (V2 12.488656 103.983955) (V2 12.488856 103.425156)
        , Line (V2 12.488856 103.425156) (V2 12.492557 102.80536)
        , Line (V2 12.492557 102.80536) (V2 12.469756 97.95916)
        , Line (V2 12.469756 97.95916) (V2 12.461156 97.52476)
        , Line (V2 12.461156 97.52476) (V2 12.480256 97.30636)
        , Line (V2 12.480256 97.30636) (V2 12.480256 97.27716)
        , Line (V2 12.480256 97.27716) (V2 12.480356 97.10316)
        , Line (V2 12.480356 97.10316) (V2 12.4735565 96.78566)
        , Line (V2 12.4735565 96.78566) (V2 12.484357 95.43696)
        , Line (V2 12.484357 95.43696) (V2 12.477557 95.07886)
        , Line (V2 12.477557 95.07886) (V2 12.476957 94.89426)
        , Line (V2 12.476957 94.89426) (V2 12.474358 93.948456)
        , Line (V2 12.474358 93.948456) (V2 12.470958 93.33875)
        , Line (V2 12.470958 93.33875) (V2 12.4672575 92.68765)
        , Line (V2 12.4672575 92.68765) (V2 12.465958 92.45995)
        , Line (V2 12.465958 92.45995) (V2 12.468058 91.999954)
        , Line (V2 12.468058 91.999954) (V2 12.457858 80.366356)
        , Line (V2 12.457858 80.366356) (V2 12.454458 80.35355)
        , Line (V2 12.454458 80.35355) (V2 12.458259 79.55355)
        , Line (V2 12.458259 79.55355) (V2 12.465359 79.02005)
        , Line (V2 12.465359 79.02005) (V2 12.458559 78.31655)
        , Line (V2 12.458559 78.31655) (V2 12.415459 64.97455)
        , Line (V2 12.415459 64.97455) (V2 12.294559 26.839947)
        , Line (V2 12.294559 26.839947) (V2 233.9148 322.0685)
        ]
  withTexture (uniformTexture (PixelRGBA8 0 0 0 255)) $ fill path
